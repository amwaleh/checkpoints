    ...
    if task == 2:
        ...
        while True:
           ...
           # try:
            ...
            if source in [3, 4, 5]:
                break
           # except:
                #print("ERROR: Insert 3 or 4 or 5")
        ...
        if source == 5:
            ...
            if room_type == 2:
                ...
                print(living_allocate(file_path))
           # except:
               # print("ERROR: Failed to Load Alloation File :(")
    ...
    if task == 3:
        while True:
            ...
            try:
                ...
                if report in [1, 2, 0]:
                    ...
                    if x > 0:
                        ...
                        if action in [1, 2]:
                            if action == 1:
                                if report is 1:
                                    living.room_list[room_num][
                                        edit] = raw_input("Insert New Name : ")
                                    print(living.room_list[room_num][edit])

                                if report is 2:
                                    office.room_list[room_num][
                                        edit] = raw_input("Insert New Name : ")
                                    print(iving.room_list[room_num][edit])
                            # Choose delete a name from a room
                            if action == 2:
                                if report is 1:
                                    del living.room_list[room_num][edit]
                                    Living.save_list()
                                    print(iving.room_list[room_num])
                ...
                print("ERROR: insert 1 or 2 or exit")
